...
public class EasyVsCPU extends AppCompatActivity {

    int c_place=0, i_place=0, guesses=0, left=12;
    String[] secret = new String[4];
    String[] secretCopy = new String[4];
    String[] guess = new String[4];
    String[] guessCopy = new String[4];
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_easy_vs_cpu);
        received = getIntent();
        createCode();
        initViews();
        createDigitsList();
    ...
    private void initViews() {
        remaining = findViewById(R.id.tv_easyVsCPU_remaining);
        lv = findViewById(R.id.lv_easyVsCPU_list);
        d1 = findViewById(R.id.sc_easyVsCPU_d1);
        d2 = findViewById(R.id.sc_easyVsCPU_d2);
        d3 = findViewById(R.id.sc_easyVsCPU_d3);
        d4 = findViewById(R.id.sc_easyVsCPU_d4);
    }
