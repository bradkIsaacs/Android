...
public class HardVsCPU extends AppCompatActivity {

    int c_place=0, i_place=0, guesses=0, left=8;
    String[] secret = new String[6];
    String[] secretCopy = new String[6];
    String[] guess = new String[6];
    String[] guessCopy = new String[6];
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hard_vs_cpu);
    ...
    private void initViews() {
        remaining = findViewById(R.id.tv_hardVsCPU_remaining);
        lv = findViewById(R.id.lv_hardVsCPU_list);
        d1 = findViewById(R.id.sc_hardVsCPU_d1);
        d2 = findViewById(R.id.sc_hardVsCPU_d2);
        d3 = findViewById(R.id.sc_hardVsCPU_d3);
        d4 = findViewById(R.id.sc_hardVsCPU_d4);
        d5 = findViewById(R.id.sc_hardVsCPU_d5);
        d6 = findViewById(R.id.sc_hardVsCPU_d6);
    }
