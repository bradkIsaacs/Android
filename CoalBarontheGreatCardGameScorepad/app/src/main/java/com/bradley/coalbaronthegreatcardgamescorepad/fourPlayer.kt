...
abstract class fourPlayer : AppCompatActivity() {
    ...
    internal abstract var p4Name: EditText
    internal abstract var p4LC: EditText
    internal abstract var p4OC: EditText
    internal abstract var p4SC: EditText
    internal abstract var p4ST: EditText
    internal abstract var p4OBJ: EditText
    internal abstract var p4SCORE: EditText
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.four_player_game)
        ...
        p4Name = findViewById<View>(R.id.p4Name) as EditText
        p4LC = findViewById<View>(R.id.p4LC) as EditText
        p4OC = findViewById<View>(R.id.p4OC) as EditText
        p4SC = findViewById<View>(R.id.p4SC) as EditText
        p4ST = findViewById<View>(R.id.p4ST) as EditText
        p4OBJ = findViewById<View>(R.id.p4OBC) as EditText
        p4SCORE = findViewById<View>(R.id.p4F) as EditText
    }
    ...
    fun scores(v: View) {
        if (p1Name.text.toString() != "" &&
            ...
            p4SCORE.setText((Integer.parseInt(p4LC.text.toString())
                    + Integer.parseInt(p4OC.text.toString())
                    + Integer.parseInt(p4SC.text.toString())
                    + Integer.parseInt(p4ST.text.toString())
                    + Integer.parseInt(p4OBJ.text.toString())).toString() + "")
            save()
        } else {
    ...
    private fun save() {
        ...
        gameplay.add(p4Name.text.toString() + ": " + p4SCORE.text.toString())
        gameplay.add("-----------------------------------------------------------")
