package developer.android.blutooth_fbs_controller;
...
public class MainActivity extends AppCompatActivity {
    ...
    Button listen, listDevices, beep, vibrate;
    ...
    private void implementListeners() {
        ...
        flashlight.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean isChecked) {
                if (isChecked){ //Torch Enabled (Flashlight On)
                    String string = "fON";
                    sendRecieve.write(string.getBytes());
                } else { //Torch Disabled (Flashlight Off)
                    String string = "fOFF";
                    sendRecieve.write(string.getBytes());
                }
            }
