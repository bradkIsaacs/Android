...
public class SendGameBagActivity extends AppCompatActivity {
    ...
    private void populate() {
        ...
        writeMsg.setAdapter(arrayAdapter);
    }
    ...
    private void implementListeners() {
        ...
        writeMsg.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                if (status.getText().toString().equals("Connected")) {
                    ...
                    Toast.makeText(getApplicationContext(), "Please make sure there is a Bluetooth connection", Toast.LENGTH_LONG).show();
                }
            }
        });
    }
        ...
        public boolean handleMessage(Message msg) {
            switch(msg.what){
                ...
                case STATE_MESSAGE_RECEIVED:
                    ...
                    list2.add(tempMsg);
                    ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(getApplicationContext(),android.R.layout.simple_list_item_1, list2);
                    writeMsg.setAdapter(arrayAdapter);
                    break;
            }
            return false;
