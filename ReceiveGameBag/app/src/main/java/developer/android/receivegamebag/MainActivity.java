package developer.android.receivegamebag;
...
public class MainActivity extends AppCompatActivity {
    Button listen, randomGame, listDevices;
    ListView listView;
    ...
    private void implimentListeners() {
        ...
        randomGame.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                int random_game = rand.nextInt(list.size());
                msg_box.setText(list.get(random_game));
            }
        });
    }
    ...
    private void viewIds() {
        randomGame = (Button)findViewById(R.id.send_message);
