...
public class BonusCard2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bonus_card2);

        Globe = (GlobalClass) getApplicationContext();
        p1 = findViewById(R.id.tv_player1Bonus2);
        p2 = findViewById(R.id.tv_player2Bonus2);
        p3 = findViewById(R.id.tv_player3Bonus2);
        p4 = findViewById(R.id.tv_player4Bonus2);
        p1Score = findViewById(R.id.et_player1Bonus2);
        p2Score = findViewById(R.id.et_player2Bonus2);
        p3Score = findViewById(R.id.et_player3Bonus2);
        p4Score = findViewById(R.id.et_player4Bonus2);
        submit = findViewById(R.id.btn_submitSecondBonus);
        ...
        submit.setOnClickListener(v -> {
            if(p1Score.getText().toString().matches("") || p2Score.getText().toString().matches("") || p3Score.getText().toString().matches("") || p4Score.getText().toString().matches("") ){
                ...
                startActivity(new Intent(this, BonusCard3.class));
            }
        });
    }
