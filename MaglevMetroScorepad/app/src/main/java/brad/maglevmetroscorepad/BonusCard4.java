...
public class BonusCard4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bonus_card4);

        Globe = (GlobalClass) getApplicationContext();
        p1 = findViewById(R.id.tv_player1Bonus4);
        p2 = findViewById(R.id.tv_player2Bonus4);
        p3 = findViewById(R.id.tv_player3Bonus4);
        p4 = findViewById(R.id.tv_player4Bonus4);
        p1Score = findViewById(R.id.et_player1Bonus4);
        p2Score = findViewById(R.id.et_player2Bonus4);
        p3Score = findViewById(R.id.et_player3Bonus4);
        p4Score = findViewById(R.id.et_player4Bonus4);
        submit = findViewById(R.id.btn_submitForthBonus);
