...
public class ArtisanScore extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_artisan_score);

        Globe = (GlobalClass) getApplicationContext();
        p1 = findViewById(R.id.tv_player1Art);
        p2 = findViewById(R.id.tv_player2Art);
        p3 = findViewById(R.id.tv_player3Art);
        p4 = findViewById(R.id.tv_player4Art);
        p1Score = findViewById(R.id.et_player1Art);
        p2Score = findViewById(R.id.et_player2Art);
        p3Score = findViewById(R.id.et_player3Art);
        p4Score = findViewById(R.id.et_player4Art);
        submit = findViewById(R.id.btn_submitArtisan);
        ...
        submit.setOnClickListener(v -> {
            if(p1Score.getText().toString().matches("") || p2Score.getText().toString().matches("") || p3Score.getText().toString().matches("") || p4Score.getText().toString().matches("") ){
                ...
                startActivity(new Intent(this, TrackScore.class));
            }
        });
    }
